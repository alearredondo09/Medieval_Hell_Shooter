...
\section*{Implementación}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item \textbf{Patron Snake:}
      
      \vspace{0.5cm}

      Este patrón se realizá mediante una variable auxiliar que me ayuda a llevar el tiempo y poder oscilar entre el angulo de rotaciones que hace es spawner
      ...
      A su vez, a la hora de instanciar el objeto, se le pasa los mismo componente con un ligero cambio, el cual es que en la rotación se le pasa el angulo de rotación que se le da a la bala sumandole el angulo de rotación que tiene el spawner convirtiendolo a entero
